...
const validationSchema = toTypedSchema(
  z.object({
    name: z.string().min(1).default("11"),
    address: z.string().min(1).default("11"),
    zipcode: z.string().min(1).default("11"),
    city: z.string().min(1).default("11"),
    country: z.string().min(1).default("11"),
    phone: z.string().default(""),
    email: z.string().email().default("mich@asd.com"),
    totalRooms: z.number().min(1).default(11),
    totalAdults: z.number().min(1).default(11),
    totalChildren: z.number().min(1).default(11),
    ageChildren: z.string().default(""),
    dateArrival: z.string().min(1).default("11"),
    dateDeparture: z.string().min(1).default("11"),
